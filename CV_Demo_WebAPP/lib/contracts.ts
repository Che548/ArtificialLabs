...
export const reasonLabels: Record<string,string> = {
  local_bands_resolve_auxiliary_uncertainty:'Распознана одна контрольная линия',
  local_bands_confirm_single_line:'Распознана одна контрольная линия',
  independent_window_local_bands:'Область результата найдена, линии распознаны',
  band_topology_confirms_single_line:'Распознана одна контрольная линия',
  learned_count_only:'Распознано число линий; измерение отношения T/C не выполняется', detector_no_proposal:'Не удалось найти тест-полоску', result_region_degenerate:'Область результата слишком мала', window_coverage_uncertain:'Область результата видна недостаточно уверенно', control_absent:'Контрольная линия не обнаружена', control_uncertain:'Контрольная линия недостаточно чёткая', test_uncertain:'Тестовая линия недостаточно чёткая', readers_do_not_confidently_agree:'Требуется проверка распознавания линий', spatial_test_absence_not_confirmed:'Не удалось уверенно определить число линий', window_readers_agree_on_coincident_peak:'Распознана одна контрольная линия', window_readers_and_spatial_absence_agree:'Распознана одна контрольная линия', readers_agree:'Распознаны две линии', invalid_model_evidence:'Недостаточно данных для уверенного распознавания',

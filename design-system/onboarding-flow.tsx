    ...
    <AppSheet
      ...
      footer={
        <View style={styles.diseaseActions}>
          ...
          >
            <AppText role="label" weight="medium" color={colors.text.secondary}>
              Не указывать
            </AppText>
          </Pressable>
          <Pressable
        ...
        >
          ...
          {step === 5 ? (
            <>
              ...
              <AppText role="caption" color={colors.text.secondary}>
                Начнём с хранения на устройстве. Облачную синхронизацию,
                аналитику и автоматические рекомендации можно отдельно включить
                в профиле — они не включаются при регистрации.
              </AppText>
